let oreList = {
    ...
    '🐰': { 'decimalRarity': 1 / 17800000, 'numRarity': 17800000, 'hasLog': false,  'caveExclusive': false, 'spawnMessage': '🐰 Has Spawned!', 'oreTier': 'Celestial',  },
    ...
    'real': { 'decimalRarity': 1 / 6666666, 'numRarity': 6666666, 'hasLog': true,  'caveExclusive': true, 'spawnMessage': 'this cat is d...', 'oreTier': 'Hyperdimensional', 'hasImage' : true, "src" : "media/ores/real.webp" },
    ...
    'evilFlag': { 'decimalRarity': 1 / Infinity, 'numRarity': Infinity, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'this is ALLEGEDLY an ore', 'oreTier': 'Infinitesimal','hasImage' : true, "src" : "media/ores/evil_flag.png","oreName": "evil Flag" },
    ...
    '🤽🏻': { 'decimalRarity': 1 / (1e18-1) /*NOT 1e18 /* ok */, 'numRarity': (1e18-1), 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: oh man you found my good buddy Jonah (not to be confused with johan, i remember that one time we went to home depot and we accidentally bought twenty thousand doors, turns out they were mitosing door, ', 'oreTier': 'Johnical', "oreName" : "Jonah"},
    '🤽🏼': { 'decimalRarity': 1 / 1e14, 'numRarity': 1e14, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: jackson and i were best buddies in school untill he fell into a wormhole that brought him straight to the vatican city, we used to meet up during lunch time to undermine the TnnA fountations authority', 'oreTier': 'Johnical', "oreName" : "Jackson" },
    '🤽🏽': { 'decimalRarity': 1 / 1.1e18, 'numRarity': 1.1e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: noah was who first me to checkmarxism, at his local library i am very greatful for his contributions to the WCP', 'oreTier': 'Johnical', "oreName" : "Noah" },
    '🤽🏾': { 'decimalRarity': 1 / 2.5e19, 'numRarity': 2.5e19, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: ron... i still remember when we first thought about the second Miku-Feline war back in the day, he was such a good advisor', 'oreTier': 'Johnical', "oreName" : "Don" },
    '🤽🏿': { 'decimalRarity': 1 / 8e16, 'numRarity': 8e16, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: johan (not to be confused with jonah) is jonahs brother, i met him once at a wedding, very nice guy', 'oreTier': 'Johnical', "oreName" : "Johan", "oreName" : "Johan" },
    '🤽🏻‍♂️': { 'decimalRarity': 1 / 1.3e18, 'numRarity': 1.3e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: woah they have red velvet cake at the party, truly incredible', 'oreTier': 'Johnical', "oreName" : "Shawn" },
    '🤽🏼‍♂️': { 'decimalRarity': 1 / 1.2e19, 'numRarity': 1.2e19, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: please make sure that jay does not bring me any bonsai cactus plants, last time it grew so much it blocked an entire room', 'oreTier': 'Johnical', "oreName" : "Jay" },
    '🤽🏽‍♂️': { 'decimalRarity': 1 / 2e18, 'numRarity': 2e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: my good buddy rowan (we called him marcus roman in school), he always had the best school projects, once he got a huge ball of plastic and turned it into a maze', 'oreTier': 'Johnical', "oreName" : "Rowan" },
    '🤽🏾‍♂️': { 'decimalRarity': 1 / 2.5e15, 'numRarity': 2.5e15, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: don and i met at the Communal pit in 1752, they were so good at climbing i instantly gave them a job', 'oreTier': 'Johnical', "oreName" : "Ron" },
    '🤽🏿‍♂️': { 'decimalRarity': 1 / 5e19, 'numRarity': 5e19, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: you wont BELIEVE what country jordan and i met', 'oreTier': 'Johnical', "oreName" : "Jordan" },
    '🤽🏻‍♀️': { 'decimalRarity': 1 / 1.5e14, 'numRarity': 1.5e14, 'hasLog': true,  'caveExclusive': true, 'spawnMessage': 'John: i dont have much to say about janine, but thank you for finding her', 'oreTier': 'Johnical', "oreName" : "Janine" },
    ...
    'evilJohn' : { 'decimalRarity': 1 / 8e16, 'numRarity': 8e16, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'you quiver in fear at the sight of a familar face but EVIL and RED', 'oreTier': 'Johnical',  'hasImage' : true, "src" : "media/ores/evil_john.png", "oreName" : "Evil John"},
    ...
    'orbOfLife':{ 'decimalRarity': 1 / 3e20, 'numRarity': 3e20, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'meowww :3', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore3.gif", "oreName" : "Orb of Life",},
    'orbOfIntelligence':{ 'decimalRarity': 1 / 9750000000000000000, 'numRarity': 9750000000000000000, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'sometimes you just gotta :3 ykwim ?!', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore4.gif", "oreName" : "Orb of Acceptance",},
    'orbOfSound':{ 'decimalRarity': 1 / 2.5e18, 'numRarity': 2.5e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'meowww :3', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore5.gif", "oreName" : "Orb of Water",},
    'orbOfTheUnknown':{ 'decimalRarity': 1 / 1e18, 'numRarity': 1e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'meowww :3', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore1.gif", "oreName" : "Orb of Time",},
    'orbOfCreation':{ 'decimalRarity': 1 / 3e21, 'numRarity': 3e21, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'meowww :3', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore2.gif", "oreName" : "Orb of Creation",},
    'ah!SoSorgy!':{ 'decimalRarity': 1 / 1e20, 'numRarity': 1e20, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'CAPITALISM WILL NOT STOP MY NEED FOR SOUR PATCH KIDS!...', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/HEHEHEHEHE.png", "oreName" : "mmmm yummers chat",},
    ...
    'masa':{ 'decimalRarity': 1 /  2000000000000000000, 'numRarity': 2000000000000000000, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': '🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛🐈‍⬛', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/masa.png", "oreName" : "Masa 🤯",},
    ...
    'nijika' : { 'decimalRarity': 1 / 1e15, 'numRarity': 1e15, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'yellow one from bocchi the rock lowk', 'oreTier': 'Flawless',  'hasImage' : true, "src" : "media/fumo_fishing/nijika_ijichi.png", "oreName" : "Nijika Ijichi"},
