let oreList = {
    ...
    '🤽🏻‍♀️': {  'numRarity': 1.5e14, 'hasLog': true,  'caveExclusive': true, 'spawnMessage': 'John: i dont have much to say about janine, but thank you for finding her', 'oreTier': 'Johnical', "oreName" : "Janine" },
    ...
    '🤽🏿‍♀️': {  'numRarity': 1.5e15, 'hasLog': true,  'caveExclusive': true, 'spawnMessage': 'John:🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️🤽‍♂️', 'oreTier': 'Johnical', "oreName" : "Rowhen", },
    ...
    'jack' : {  'numRarity': 5e19, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: what the hell why does he look like that maybe i dont need my wallet back anymore', 'oreTier': 'Johnical',  'hasImage' : true, "src" : "media/ores/jack.png", "oreName" : "Jack"},
    'heavenlyJohn' : {  'numRarity': 5e18, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: do you think he accepts bribes', 'oreTier': 'Johnical',  'hasImage' : true, "src" : "media/ores/heavenly_john.png", "oreName" : "Heavenly John"},
    ...
    '🤽': {  'numRarity': 1, 'hasLog': false,  'caveExclusive': false, 'spawnMessage': '', 'oreTier': 'Layer', "oreName" : "Jim" },
    ...
    //'planetIX':{  'numRarity': 900000000000, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'Once thought to be a mere rumor, a new celestial body reveals itself to you...', 'oreTier': 'Ethereal',  'hasImage' : true, "src" : "media/ores/planetIX.png", "oreName" : "Planet IX",},
    ...
    'orbOfIntelligence':{  'numRarity': 9750000000000000000, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'sometimes you just gotta :3 ykwim ?!', 'oreTier': 'Polychromatical',  'hasImage' : true, "src" : "media/ores/ore4.gif", "oreName" : "Orb of Acceptance",},
