let oreList = {
    ...
    '🤽🏻': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: oh man you found my good buddy Jonah (not to be confused with johan, i remember that one time we went to home depot and we accidentally bought twenty thousand doors, turns out they were mitosing door, ', 'oreTier': 'Johnical',  },
    ...
    '🤽🏽': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: noah was who first me to checkmarxism, at his local library i am very greatful for his contributions to the WCP', 'oreTier': 'Johnical',  },
    '🤽🏾': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: ron... i still remember when we first thought about the second Miku-Feline war back in the day, he was such a good advisor', 'oreTier': 'Johnical',  },
    '🤽🏿': { 'decimalRarity': 1 / 5e16, 'numRarity': 5e16, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: johan (not to be confused with jonah) is jonahs brother, i met him once at a wedding, very nice guy', 'oreTier': 'Johnical',  },
    '🤽🏻‍♂️': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: woah they have red velvet cake at the party, truly incredible', 'oreTier': 'Johnical',  },
    '🤽🏼‍♂️': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: please make sure that jay does not bring me any bonsai cactus plants, last time it grew so much it blocked an entire room', 'oreTier': 'Johnical',  },
    '🤽🏽‍♂️': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: my good buddy rowan (we called him marcus roman in school), he always had the best school projects, once he got a huge ball of plastic and turned it into a maze', 'oreTier': 'Johnical',  },
    '🤽🏾‍♂️': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: don and i met at the Communal pit in 1752, they were so good at climbing i instantly gave them a job', 'oreTier': 'Johnical',  },
    '🤽🏿‍♂️': { 'decimalRarity': 1 / 5e17, 'numRarity': 5e17, 'hasLog': true,  'caveExclusive': false, 'spawnMessage': 'John: you wont BELIEVE what country jordan and i met', 'oreTier': 'Johnical',  },
