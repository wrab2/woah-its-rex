...
function rollNavalEvent(){ //this runs on every inventory (2 times a second)
	...
	if(availableNavalEvents.length > 0 && Math.random()<1/3600){
		...
		if(player.gears["ring_of_water"]) {
			currentNavalEvent.duration = currentNavalEvent.duration * Math.min(1, (1 - (( 5+3*Math.log(200) )/100)) )
		}
...
const johnContributions = [
	...
	"meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow meow -my cat while shes in heat",
	...
	"john took all of $loser's ores causing them to be very sad because they were sentimental of them",
	"john made $loser use 7-3 stacking in tetris without telling them about t parity",
	"john taught $winner how to surge farm with all spin",
	"https://drive.google.com/file/d/1rxOZqcaApCmi08LSl5801kHEERCVlzaG/view?usp=sharing john enabled this on $loser's fleet's computers (catbox didnt work)",
	"",
	"",
	"",
	"yuri on ice but its john on water and $loser is the other guy and they are doing a naval battle instead of figure skating (i have never watched yuri on ice)",
	"john called over his good buddy jim and jim was really mad because someone stole their water polo hat so they took out their anger on $loser's crew",
	"john didn't do anything, but $loser's crew got demotivated just by thinking about how much work john put into the event page",
	"palantir owns all of $loser's info (john kindly asked for them to do that), this didnt really help in the battle but still",
	"",
	"",
	"",
	"",
...
new navalEvent('Sinking of the P-11','P-11 is sunk','Eritrean People\'s Liberation Front','Ethiopians (P-11)')
...
new navalEvent('Sinking of Transit','Transit is sunk off Tripoli, Lebanon; of the 56 refugees en route to Larnaca, Cyprus, 25 are killed','Israelis','Lebanese')
new navalEvent('Sinking of Milanian and Kahnamoie','Milanian and Kahnmoie are sunk by Exocet missiles','Iraqis','Iranians (Milanian and Kahnamoie)')
...
new navalEvent('Dahlak Islands Campaign','F-1616 is damaged beyond repair and later scuttled','Eritreans','Ethiopians (F-1616)')
...
new navalEvent('Action of 8 August','Blue Shadow is sunk','Spanish Nationalists (Almirante Cervera)','British (Blue Shadow)')
new navalEvent('Battle of Majorca','Republican amphibious assault fails','Spanish Nationalists','Spanish Republicans')
new navalEvent('Spanish Guinea uprising','','Spanish Nationalists','Spanish Republicans')
new navalEvent('Battle of Cape Espartel','','Spanish Nationalists','Spanish Republicans (Almirante Ferrándiz)')
new navalEvent('Action of 14 December','Komsomol is sunk off Oran','Spanish Nationalists (Canarias)','Soviets (Komsomol)')
new navalEvent('Action of 10 January','Smidovich is captured','Spanish Nationalists (Velasco)','Soviets (Smidovich)')
new navalEvent('Battle of Cape Machichaco','','Spanish Republicans and Basques','')
new navalEvent('Action of 28 March','Gardelaki is captured','Spanish Nationalists (Uad Kert)','Greeks (Gardelaki)')
new navalEvent('Action of 2 April','Poli is sunk','Spanish Nationalists (Baleares)','Greeks (Poli)')
new navalEvent('Action of 4 April','Janu is captured','Spanish Nationalists (Huelva)','Panamanians (Janu)')
new navalEvent('Action of 5 April','Nagos is captured','Spanish Nationalists (Maria Teresa)','Greeks (Nagos)')
...
new navalEvent('Action of 16 April','Hordena is captured','Spanish Nationalists (Almirante Cervera)','Panamanians (Hordena)')
new navalEvent('Attack on the Barletta','Barletta is bombed; six Italian sailors are killed','Spanish Republicans','Italians (Barletta)')
new navalEvent('Attack on the Albatros','No casualties','Spanish Republicans','Germans (Albatros)')
new navalEvent('Deutschland incident','','Germans (Deutschland)','Thirty-one aboard the Deutschland are killed and 74 are injured')
new navalEvent('Bombardment of Almería','','Spanish Republicans','Retaliation for attack on Admiral Scheer')
new navalEvent('Action of 7 July','','French (Liberte)','Liberte is captured')
new navalEvent('Action of 14 July','','British (Molton and Royal Oak)','Molton seized off Santander')
new navalEvent('Battle of Shanghai','In the Yangtze River; Japanese capture Shanghai','Japanese','Chinese')
new navalEvent('Action of 15 August','George W. McKnight is disabled','Italians (Freccia)','Panamanians (George W. McKnight)')
new navalEvent('Action of 11 August 1937','Campeador is sunk','Italians (Saetta)','Spanish Republicans (Campeador)')
new navalEvent('Action of 31 August','Timiryazev is sunk','Italians (Turbine)','Soviets (Timiryazev)')
new navalEvent('Action of 1 September','Woodford is sunk','Italians (Diaspro)','British (Woodford)')
new navalEvent('Action of 3 September','Blagoev is sunk','Italians (Luigi Settembrini)','Soviets (Blagoev)')
new navalEvent('Battle of Cape Cherchell','','Spanish Nationalists (Baleares)','Spanish Republicans under Buiza')
new navalEvent('Action of 12 December','Sydney is captured','Spanish Nationalists (Lazaro)','French (Sydney)')
new navalEvent('USS Panay incident','Panay sunk','Japanese under Murata and Okumiya','Americans (Panay)')
new navalEvent('Action of 21 September','Francois is captured','Spanish Nationalists (Mallorca)','French (Francois)')
new navalEvent('Sinking of the Endymion','Endymion is sunk','Spanish Nationalists (General Sanjurjo)','British (Endymion)')
new navalEvent('Capture of the Pomaron','Pomaron captured','Spanish Nationalists (Vincente Puchol)','Estonians (Pomaron)')
new navalEvent('Action of 22 January','','Estonians (Juss)','Juss is captured')
new navalEvent('Battle of Cape Palos','','Spanish Republicans under González','Spanish Nationalists (Baleares)')
new navalEvent('Action of 19 March','Lensovet is captured','Spanish Nationalists','Soviets (Lensovet)')
new navalEvent('Sinking of the Lena','','Spanish Nationalists (General Mola)','Greeks (Lena)')
new navalEvent('Capture of the Alix','Alix is captured','Spanish Nationalists (Huevla)','Norwegians (Alix)')
new navalEvent('Action of 19 May','Ellinico Vuono is captured','Spanish Nationalists (Canarias)','Greeks (Ellinico Vuono)')
new navalEvent('Capture of the Stepanov','','Spanish Nationalists (Canarias)','Soviets (Skvortzov Stepanov)')
new navalEvent('Capture of the Jan','Jan is captured','Spanish Nationalists (Iñasi)','Danish (Jan)')
new navalEvent('Action of 30 May','Wintonia is captured','Spanish Nationalists','Panamanians (Wintonia)')
new navalEvent('Action of 31 May','Potishev is captured','Spanish Nationalists (Vicente Puchol)','Soviets (Potishev)')
new navalEvent('Battle of Wuhan','Japanese capture Wuhan','Japanese','Chinese')
...
new navalEvent('Action of 15 January','Aunis is captured','Spanish Nationalists (Dato)','French (Aunis)')
new navalEvent('Action of 28 January','Lake Lugano is sunk','Spanish Nationalists (Mar Negro)','British (Lake Lugano)')
new navalEvent('Battle of Durrës','','Italians under Sportiello','Albanians under Ulqinaku')
new navalEvent('Battle of Danzig Bay','','Germans','Polish')
new navalEvent('Battle of Hel','','Polish under Steyer','All Polish ships are sunk or captured')
new navalEvent('Battle of the Atlantic','','Allies','Germans and Italians')
new navalEvent('Battle of Russarö','Finnish coastal guns damage Soviet warships, forcing their retreat','Finnish','Soviets (Kirov, Stremitelny and Smetlivy)')
new navalEvent('Battle of the River Plate','Admiral Graf Spee is damaged and later scuttled','British and New Zealanders under Harwood','Germans under Langsdorff (Admiral Graf Spee)')
new navalEvent('Battle of Utö','Finnish repel Soviets from attacking a lighthouse','Finnish','Soviets')
new navalEvent('Battle of the Heligoland Bight','','Germans under Schumacher','British')
new navalEvent('Action of 8 April 1940','Glowworm is sunk','Germans (Admiral Hipper)','British (Glowworm)')
new navalEvent('Preceding Battle of Narvik','','Norwegians (Norge and Eidsvold)','Norwegian coastal defense ships are sunk')
new navalEvent('Battle of Drøbak Sound','','Germans (Blücher)','Blücher is sunk near Oscarsborg Fortress')
new navalEvent('Battle of Horten Harbour','','Germans under Strelow and Wilcke (Emden)','Norwegians')
new navalEvent('Battle of Kristiansand','','Germans (Karlsruhe and Seattle)','Norwegians')
new navalEvent('Capture of Arendal','','Germans (Greif)','Norwegians under Holthe (Jo)')
new navalEvent('First Battle of Narvik','','British','Germans')
new navalEvent('Sinking of the Rio de Janeiro','','Polish (Orzel)','Germans (Rio de Janeiro)')
new navalEvent('Second Battle of Narvik','','British under Whitworth (Warspite)','Germans under Bey')
new navalEvent('Dunkirk evacuation','More than 338,000 Allied soldiers are evacuated','Allies (British, French, Polish, Dutch, & Belgians)','Germans')
new navalEvent('Operation Juno','Glorious and to destroyers are sunk','Germans under Marschall (Scharnhorst and Gneisenau)','British under D\'Oyly-Hughes (Glorious)')
new navalEvent('Italian invasion of France','Italian occupied zone is created in southern France','Italians','French')
new navalEvent('Convoy HX 47','Two British merchant ships are sunk','Germans under Dönitz','British')
...
new navalEvent('Battle of Cape Spada','Off Crete','British & Australians under Collins (Sydney)','Italians under Casardi (Bartolomeo Colleoni)')
new navalEvent('Sinking of the Elli','Elli is sunk','Italians (Delfino)','Greeks (Elli)')
new navalEvent('Convoy FS 271','','British','Germans under Dönitz')
new navalEvent('Convoy SC 2','','Canadians and British','Germans under Dönitz')
new navalEvent('Convoy HX 72','','British','Germans under Dönitz')
new navalEvent('Battle of Dakar','Vichy French fight off Allied landing at Dakar','Vichy French','British, Free French and Australians')
new navalEvent('Battle of Cape Passero','Three Italian destroyers are sunk','British under McCarthy (Ajax and York)','Italians')
new navalEvent('Convoy SC 7','20 ships sunk in North Atlantic','Germans under Dönitz','British under Mackinnon')
new navalEvent('Convoy HX 79','','Germans under Dönitz','British')
new navalEvent('Attack on Convoy BN 7','One Italian destroyer is sunk','Allies (British, Indians, Australians, & New Zealanders) under Rivett-Carnac','Italians under Borsini')
new navalEvent('Operation MB8','','British under Cunningham and Lyster','Italians under Campioni')
new navalEvent('Convoy HX 84','Five ships sunk in North Atlantic','Germans under Krancke','British under Fegen')
new navalEvent('Battle of Gabon','Bougainville is sunk','Free Frenchunder d\'Argenlieu (Savorgnan de Brazza)','Vichy French (Bougainville)')
new navalEvent('Battle of Taranto','Air attack on Italians anchored at Taranto, inspiring the Japanese attack on Pearl Harbor','British under Cunningham and Lyster','Italins under Campioni')
new navalEvent('Battle of the Strait of Otranto','Italian convey is destroyed','British and Australians','Italians')
...
new navalEvent('Operation Excess','Royal Navy engages maritime strike Luftwaffe','British and Australians','Italians and Germans')
new navalEvent('Convoy SC 19','Four Allied merchant ships are sunk','Germans under Dönitz','British & Canadians')
new navalEvent('Battle of Ko Chang','','Vichy France','Thailand')
new navalEvent('Convoy SC 20','Five Allied merchant ships are sunk','Germans under Dönitz','British & Canadians')
new navalEvent('Operation Berlin','Twenty-two British merchant ships are sunk or captured','Germans under Lütjens (Scharnhorst and Gneisenau)','British under Tovey')
new navalEvent('Convoy HX 106','Two British merchant ships are sunk','Germans under Lütjens and Dönitz (Scharnhorst and Gneisenau)','British & Canadians')
new navalEvent('Attack on Convoy AN 14','Allied merchant ship disabled','Italians under Mimbelli','Allies (British, Australians, & Greeks) under Packer')
...
new navalEvent('Convoy HX 112','U-boats attack Allied convoy; Allies suffer minimal losses and sink two U-boats','British & Canadians','Germans under Dönitz')
new navalEvent('Raid on Souda Bay','York and Pericles are sunk','Italians under Faggioni','British (York) Norwegians (Pericles) under Portal')
new navalEvent('Battle of Cape Matapan','','Italians under Iachino','')
new navalEvent('Convoy SC 26','Ten ships sunk and one U-boat destroyed in North Atlantic','Germans under Dönitz','British')
new navalEvent('Action of 4 April','Voltair sunk','Germans under Kähler (Thor)','British (Voltair)')
new navalEvent('Invasion of Yugoslavia','Yugoslav Fleet attempts to repel Axis air attacks and river operations, most Yugoslav ships are sunk or captured.','Germans, Italians, & Hungarians','Yugoslavs')
new navalEvent('Battle of the Tarigo Convoy','Duisburg, Lampo, Luca Tarigo, Baleno and Mohawk are sunk','British under Mack (Mohawk)','Italians under Cristofaro (Duisburg, Lampo, Luca Tarigo and Baleno)')
...
new navalEvent('Gulf of Riga campaign','Series of light engagements between German and Soviet ships, results in German control of the Gulf of Riga','Germans under Schmunt','Soviets under Tributs')
new navalEvent('Western Black Sea raids','Series of raids conducted by the Soviets along Romanian and Bulgarian coasts fails to disrupt Axis shipping','Axis (Germans, Romanians, & Bulgarians) under Macellariu','Soviets under Oktyabrskiy')
new navalEvent('Raid on Constanța','','Romanians and Germans','Soviets under Oktyabrskiy')
new navalEvent('Action of 26 June','','Romanians','Soviets')
new navalEvent('Action of 9 July','','Romanians','Soviets')
new navalEvent('Operation München','','Romanians & Germans (air support) under Macellariu (Mihail Kogălniceanu)','Soviets under Oktyabrskiy')
new navalEvent('Operation Substance','Italians attack British convoy while en route to Malta','British & Australians under Somerville (Force H)','Italians')
new navalEvent('Convoy OG 69','Submarines inflict heavy casualties on British convoy','Germans and Italians under Dönitz','British')
new navalEvent('Battle of Bengtskär','Finnish gunboats sink a Soviet patrol boat during an attempted invasion of Bengtskär','Finnish','Soviets')
new navalEvent('Convoy HG 70','Minimal losses on both sides','British','Germans and Italians under Dönitz')
...
new navalEvent('Battle of Khuzestan','Babr and Palang are sunk','British and Australians','Iranians (Babr and Palang)')
new navalEvent('Capture of U-570','Allies capture U-570','British and Canadians','Germans (U-570)')
new navalEvent('Soviet evacuation of Tallinn','','Germans and Finnish','Soviets under Tributs')
new navalEvent('Convoy SC 42','Fourteen ships and two U-boats sunk in North Atlantic','Germans under Dönitz','British and Canadians')
new navalEvent('Convoy HG 73','','Germans under Dönitz','British')
new navalEvent('Operation Halberd','','British under Somerville','Italians under Iachino')
new navalEvent('Convoy SC 48','Eleven ships sunk in North Atlantic','Germans under Dönitz','British and Canadians')
new navalEvent('Convoy HX 156','','British and Americans','Germans under Dönitz')
new navalEvent('Siege of Sevastopol','Soviet Black Sea Fleet fails to defend Sevastopol from Axis','Italians, Germans (air support), & Romanians (air support)','Soviets under Oktyabrskiy and Levchenko')
new navalEvent('Sinking of Uralets','Uralets sunk','Romanians (Delfinul)','Soviets (Uralets)')
new navalEvent('Battle of the Duisburg Convoy','Italian convoy destroyed','British under Agnew','Italians under Brivonesi')
new navalEvent('Action of 6 December','','Bulgarians (Chernomorets and Belomorets)','Soviets (Shch-204)')
new navalEvent('Pearl Harbor','Started the Pacific War; Japanese launch surprise raid on American naval base, forcing United States to enter World War II','Japanese under Yamamoto and Nagumo','Americans under Kimmel and Short')
new navalEvent('Battle of Wake Island','American coastal and air defenses at Wake Island hold off Japanese invasion for 15 days','Japanese','Americans')
new navalEvent('Battle of Hong Kong','Japanese occupy Hong Kong','Japanese under Niimi','British & Indians')
new navalEvent('Sinking of Prince of Wales and Repulse','Prince of Wales and Repulse are sunk by Japanese air attack in the South China Sea','Japanese','British (Prince of Wales and Repulse)')
new navalEvent('Battle of Cape Bon','','British and Dutch','Italians under Toscano')
new navalEvent('Battle of Borneo','Japanese occupy British and Dutch Borneo','Japanese','British and Dutch')
new navalEvent('Battle of Jibrieni','Soviets lose a submarine','Romanians, Bulgarians, & Hungarians','Soviets')
new navalEvent('Raid on Alexandria','In Alexandria Harbor','Italians under Borghese','British under Morgan')
new navalEvent('Convoy HG 76','Four ships sunk and five U-boats destroyed','British','Germans under Dönitz')
...
new navalEvent('Battle off Endau','Vampire is sunk','Japanese under Hashimoto','Australians (Vampire)')
new navalEvent('Battle of Ambon','Japanese invade Ambon Island; W-9 is sunk and Heron is damaged but survives. Dutch and Australian prisoners of war of massacred.','Japanese under Takagi and Itō (W-9)','Americans, Australians, & Dutch (Heron)')
new navalEvent('Convoy SC 67','','British, Canadians, & Norwegians','Germans under Dönitz')
new navalEvent('Marshalls-Gilberts raids','Japanese bases endure minor damage','Americans, Gilbertese and Elliceans under Halsey and Fletcher','Japanese under Inoue and Gotō')
new navalEvent('Battle of Makassar Strait','','Japanese under Tsukahara','Americans and Dutch under Doorman')
new navalEvent('Channel Dash','Major Kriegsmarine surface units escape from occupied France to Germany; British attempt to intercept with disastrous results','Germans under Ciliax','British under Ramsay')
new navalEvent('Battle of Palembang','Li Wo sinks a Japanese transport, but is later sunk herself','Japanese','British (Li Wo)')
new navalEvent('Attack on Aruba','Several German U-boats sink several Allied oil tankers in coordinated attack','Germans and Italians under Hartenstein','Dutch and Americans under Andrews')
new navalEvent('Operation Neuland','In the Caribbean Sea','Germans and Italians under Dönitz and Polacchini','Americans under Hoover')
...
new navalEvent('Bombing of Darwin','Japanese attack Australia','Japanese under Nagumo and Fuchida','Australians and Americans')
new navalEvent('Convoy ON 67','Eight ships sunk in North Atlantic','Germans under Dönitz','Americans and Canadians')
new navalEvent('Battle of the Java Sea','','Japanese under Takagi','Allies (Americans, British, Australians, & Dutch) under Doorman')
new navalEvent('Sinking of the Langley','','Japanese','Americans (Langley)')
new navalEvent('Battle of Sunda Strait','','Japanese','Americans, Australians, & Dutch under Waller and Rooks (Houston, Perth and Evertsen)')
new navalEvent('Second Battle of the Java Sea','','Japanese under Takagi and Takahashi','British and Americans under Gordon (Exeter, Encounter and Pope)')
new navalEvent('Scuttling of USS Perch','','Japanese','Americans (Perch)')
new navalEvent('Last Stand of HMAS Yarra','','Japanese','Australians (Yarra)')
new navalEvent('Second Battle of Sirte','Italians fail to sink British cargo ships; delay of the convoy led to the loss of four freighters by air attack','British under Vian','Italians under Iachino')
new navalEvent('Action of 27 March','Atik is sunk','Germans under Hardegen (U-123)','Americans (Atik)')
new navalEvent('St Nazaire Raid','British crash into Normandie dry dock, rending it useless for the rest of the war','British under Ryder and Beattie (Campbelltown)','Germans under Mecke, Schulz and Sohler')
new navalEvent('Convoy PQ 13','Trinidad is damaged','Germans','British, Soviets, & Polish (Trinidad)')
...
new navalEvent('Action of 6 June','Stanvac Calcutta is sunk','Germans (Stier)','Americans (Stanvac Calcutta)')
new navalEvent('Operation Vigorous','Six ships sunk from convoy to Malta','Italians under Iachino','British, Polish, & Greek (air support) under Vian')
new navalEvent('Operation Harpoon','','Germans & Italians under da Zara','British & Australians under Curteis and Hardy')
new navalEvent('Convoy PQ 17','24 ships sunk from Arctic convoy to Soviet Union','Germans under Raeder, Dönitz and Stumpff','Allies (British, Americans, Free French, & Soviets) under Tovey, Pound, Hamilton, Broome and Dowding')
new navalEvent('Action of 5 July','Arare is sunk','Americans (Growler)','Japanese (Arare)')
new navalEvent('Convoy QS-15','Three merchant ships are sunk','Germans (U-132)','Canadians')
new navalEvent('Battle of Someri','Soviet gunboats engaged and sunk','Finnish and Germans','Soviets under Levechenko')
...
new navalEvent('Operation Lilliput','Australians provides escort to New Guinea convoys, defends them from Japanese air attacks','Australians & Americans','Japanese')
new navalEvent('Convoy ON 154','Fourteen ships and one U-boat sunk in North Atlantic','Germans under Dönitz','British, Canadians, & Americans under Egerton and Windeyer')
new navalEvent('Convoy JW 51B','','British & Dutch under Tovey, Sherbrooke and Burnett','Germans under Dönitz, Kummetz and Stumpff')
new navalEvent('Battle of the Barents Sea','','British under Sherbrooke and Burnett (Convoy JW 51B)','Germans under Kummetz')
new navalEvent('Convoy TM 1','Seven ships sunk in North Atlantic','Germans','British & Belgians')
new navalEvent('Operation Ke','Japan withdraws from the Solomon Islands; Allied and Japanese fleets conduct final engagements of the Guadalcanal campaign','Japanese under Yamamoto and Imamura','Americans, Australians, & New Zealanders under Halsey and Patch')
new navalEvent('Battle off Zuwarah','British sink Italian minesweepers','British','Italians under Di Bartolo')
new navalEvent('Convoy SG-19','Dorchester is sunk with a loss of 674 out of 904 of her crew, the greatest American loss of life from a single ship in a convoy','Germans (U-223)','Americans (Dorchester)')
...
new navalEvent('Allied Invasion of Sicily','Allied amphibious assault on Sicily','Americans, British, Canadians, Australians, & Indians','Italians & Germans')
new navalEvent('Battle of Gela','Allies engage Italian coastal batteries during the Allied Invasion of Sicily','Americans & British','Italians & Germans')
new navalEvent('Battle of Kolombangara','','Japanese under Isaki','Americans/New Zealanders under Ainsworth')
new navalEvent('Operation Scylla','Italians repel attack by British torpedo boats, sinking one','Italians (Scipione Africano)','British')
new navalEvent('Action of 31 July','U-199 is sunk off Rio de Janeiro','Americans and Brazilians','Germans (U-199)')
new navalEvent('Battle of Vella Gulf','American destroyers intercept the "Tokyo Express" and sink 3 Japanese destroyers','Americans under Moosbrugger','Japanese under Sugiura')
new navalEvent('Battle off Horaniu','Japanese convoy evacuation succeeds','Japanese under Ijuin','Americans under Ryan')
...
new navalEvent('Convoys ONS 18/ON 202','German U-boats simultaneously attack two convoys but are defeated','British & Canadians','Germans under Dönitz')
new navalEvent('Convoy SC 143','Allies sink three U-boats after Germans attack the convoy','British, Polish, & Canadians (air support)','Germans')
new navalEvent('Naval Battle of Vella Lavella','','Japanese under Ijuin','Americans under Walker')
new navalEvent('Convoys ONS 20/ON 206','Only one Allied ship is lost during a large U-boat attack','British & Canadians','Germans under Dönitz')
new navalEvent('Battle of Sept-Îles','','Germans under Kohlauf','British')
new navalEvent('Convoy ON 207','Three U-boats sunk by a combination of air and naval support in the North Atlantic','British & Canadians','Germans under Dönitz')
new navalEvent('Convoy SL 138/MKS 28','','British','Germans under Dönitz')
new navalEvent('Battle of Empress Augusta Bay','','Americans under Merrill and Burke','Japanese unter Omori and Ijuin')
new navalEvent('Action off Cape Bougaroun','Several Allied ships are sunk by Germans','Germans','Americans, British, & Greeks')
new navalEvent('Action of 13 November','I-34 is sunk','British under Wingfield (Taurus)','Japanese (I-34)')
new navalEvent('Convoy SL 139/MKS 30','One ship and three U-boats sunk','British & Canadians (air support)','Germans under Dönitz')
new navalEvent('Convoy SL 140/MKS 31','Allie sink six U-boats','British & Americans','Germans')
new navalEvent('Battle of Cape St. George','American destroyers intercept the "Tokyo Express" and sink three Japanese destroyers','Americans under Burke','Japanese under Kagawa')
new navalEvent('Action off Silba','Three British torpedo boats attack and permanently disable Zniam','British','Croatians (Zniam)')
new navalEvent('Battle of North Cape','','Germans under Bey','')
new navalEvent('Operation Stonewall','Allied ships and aircraft sink three German destroyers in the Bay of Biscay','Allies - Americans, British, New Zealanders, Free French, Italians, Canadians (air support), Australians (air support), Brazilians (air support), & Czechoslovaks (air support) under Leatham','Germans under Dönitz')
new navalEvent('Action of 11 January','Tally-Ho sinks Kuma off Penang','British under Bennington (Tally-Ho)','Japanese (Kuma and Urunami)')
new navalEvent('Action off Visakhapatnam','Indian sloop HMIS Jumna and Australian corvettes HMAS Launceston & HMAS Ipswich sink Japanese submarine Ro-110 with depth charges.','Indians & Australians','Japanese')
new navalEvent('Action of 14 February','Tally-Ho sinks UIT-23 off Penang','British under Bennington (Tally-Ho)','Germans (UIT-23)')
...
new navalEvent('Invasion of Normandy','Allied fleets launch the largest amphibious invasion ever conducted in occupied France. Allied warships battle German coastal defenses and torpedo boats, losing several warships in the invasion.','Allies - Americans, British, Canadians, Free French, Norwegians, Polish, Greeks, Dutch, Australians (air support), & Southern Rhodesians (air support) under Ramsay','Germans')
new navalEvent('Capture of U-744','U-744 is captured and later scuttled','British and Canadians','Germans (U-744)')
new navalEvent('Battle of Ushant','','British, Canadians, & Polish (10th destroyer flotilla)','Germans under von Bechtolsheim (8th destroyer flotilla)')
new navalEvent('Battle of the Philippine Sea','US invasion of Saipan initiates the largest aircraft carrier battle in history; this battle included the air conflict nicknamed The Great Marianas Turkey Shoot','Americans under Spruance and Mitscher','Japanese under Ozawa, Kurita, Takagi and Kakuta')
new navalEvent('Battle of Nerva Island','Soviets repel German attack; T31 is sunk','Soviets','Germans (T30 and T31)')
new navalEvent('Action off Murter Island','T7 is damaged and beached off Murter Island','British','Germans & Croatians (T7)')
new navalEvent('Action of 17 July','I-166 is sunk off Penang','British under King (Telemachus)','Japanese (I-166)')
...
new navalEvent('Action of 12 August 1944','Indian sloop HMIS Godavari & British frigate HMS Findhorn sink German submarine U-198 with depth charges.','Indians & British','Germans')
new navalEvent('Battle of Port Cros','UJ6081 and SG21 sunk','Americans (Somers)','Germans (UJ6081 and SG21)')
new navalEvent('Operation Dragoon','','Germans','Combined Allied fleet launches amphibious assault resulting in Germany\'s withdrawal from most of Southern France')
new navalEvent('Convoy Hi-71','Americans attack Japanese convoy and sink nine ships and damage another three','Americans under Donaho','Japanese (Taiyō)')
new navalEvent('Shin\'yo Maru Incident','','Japanese (Shi\'yo Maru)','Americans sink Shin\'yo Maru, killing 688 Allied POWs')
new navalEvent('Operation Tanne Ost','Germans attempt to capture Suursaari Island from Finland, but are repelled. Starts the Lapland War.','Finnish','Germans')
new navalEvent('Battle of Tornio','Finnish gunboats engage German coastal batteries and cover troop landings.','Finnish','Germans')
new navalEvent('Action of 6 October','U-168 is sunk in the Java Sea','Dutch (Zwaardvisch)','Germans (U-168)')
new navalEvent('Formosa Air Battle','American carrier-based aircraft and Japanese naval aircraft battle over Formosa','Americans under Halsey and Mitscher','Japanese under Kusaka and Fukudome')
...
new navalEvent('Convoy WEP 3','Léopoldville is torpedoed and sunk with a loss of 819 lives','British & Belgians (Léopoldville)','Germans (U-486)')
new navalEvent('South China Sea raid','Japanese shipping is disrupted in the South China Sea','Americans under Halsey and McCain','Japanese under Terauchi')
new navalEvent('Sinking of U-864','','British under Launders','Germans under Wolfram (U-864)')
new navalEvent('Sinking of U-174','U-174 is sunk; no survivors','South Africans (Natal)','Germans (U-174)')
new navalEvent('Battle of the Ligurian Sea','British sink two German destroyer escorts','British under Hetherington (Lookout and Meteor)','Germans')
new navalEvent('First Bombing of Kure','American carrier-based aircraft damage Japanese warships at anchor in Kure','Americans','Japanese')
new navalEvent('Battle of Okinawa','','Japanese under Toyoda and Ōru (Yamato)','The Japanese lose their last significant naval force; large scale systematic kamikaze operations conducted by Japanese air forces')
new navalEvent('Operation Kikusui','','Japanese under Ugaki','Kamikaze campaign against Allied warships begins')
new navalEvent('Capture of U-1024','Two British frigates capture German submarine U-1024 in the Irish Sea','British (Loch Glendhu and Loch More)','Germans (U-1024)')
new navalEvent('Operation Teardrop','Anti-submarine warfare campaign along the North American east coast','British & Norwegians under Ingram','Germans under Godt')
new navalEvent('Action of 16 April','Trombe is destroyed beyond repair off Liguria','Italians','French (Trombe)')
new navalEvent('Action of 23 April','U-183 is sunk in the Java Sea','Americans (Besugo)','Germans (U-183)')
...
new navalEvent('Sinking of the Emir Farouk','Emir Farouk is sunk off Gaza','Israelis','Egyptians')
new navalEvent('Amethyst Incident','British warships come under fire by Communist Chinese coastal artillery, forcing more Royal Navy ships to come to their rescue and resulting in Britain withdrawing from the Yangtze River and mainland China','Chinese','British (Amethyst, Consort, London, Black Swan and Concord)')
new navalEvent('Battle of Guningtou','','Taiwanese','Chinese')
new navalEvent('Battle of Korea Strait','North Korean steamer is sunk','South Koreans (PC-823)','North Koreans')
new navalEvent('Battle of Chumonchin Chan','','United Nations','US and British cruisers intercept Korean People\'s Navy convoy')
new navalEvent('Battle of Haeju','','United Nations','North Koreans')
new navalEvent('Battle of Incheon','','South Korea and United Nations','North Koreans')
new navalEvent('Blockade of Wonsan','Longest naval blockade in modern history at 861 days','United Nations','North Koreans and Chinese')
new navalEvent('USS Walke incident','','North Koreans','Americans (Walke)')
new navalEvent('Manhattan Rebellion','Sri Ayudhya is sunk by coastal guns and air strikes during a failed coup','Government of Phibun','Rebels from the Royal Thai Navy (Sri Ayudhya)')
new navalEvent('Battle of the Buzz Saw','','Americans (O\'Brien, Blue, Alfred A. Cunningham and Frank E. Evans)','North Koreans')
new navalEvent('Battle of the Han River','Australians attack Chinese coastal batteries','Australians (Murchison)','Chinese')
new navalEvent('Sinking of ROCS Tai Ping','','Chinese Communists','Chinese Nationalists (Tai Ping)')
new navalEvent('Battle off Haifa','Ibrahim el-Awal is captured','Israelis and French','Egyptians (Ibrahim el-Awal)')
new navalEvent('Sinking of the Domiat','Domiat sunk in the northern Red Sea','British (Newfoundland and Diana)','Egyptians (Domiat)')
new navalEvent('First Battle of Jinmen Island','Chinese attack a convoy off Jinmen Island, sinking a transport and damaging a landing ship','Chinese','Taiwanese')
new navalEvent('Battle of Dongding Island','','Chinese','Taiwanese prevent Chinese from landing on Dongding Island; one Taiwanese landing ship is sunk, while another is damaged')
new navalEvent('Bay of Pigs Invasion','Failed attempt to invade Castro\'s Cuba','Cubans','Americans and Cuban exiles')
new navalEvent('Bizerte crisis','Failed attempt to blockade a French naval base in Bizerte','French','Tunisians')
new navalEvent('Naval battle at Mormugao harbour','Afonso de Albuquerque is sunk','Indians (Betwa and Beas)','Portuguese (Afonso de Albuquerque)')
new navalEvent('Naval Action at Diu','Vega sunk ','Indians (Delhi)','Portuguese (Vega)')
new navalEvent('Battle of Arafura Sea','Dutch repel Indonesian attack','Dutch','Indonesians under Sudarso')
new navalEvent('El Porteñazo','Rebellion Venezuelan warships exchange fire on loyalist positions ','Venezuelan government','Venezuelan military rebels')
new navalEvent('Battle of the Taku Forts','Chinese coastal forts are bombarded and captured','Eight-Nation Alliance','Chinese')
new navalEvent('Battle between Panther and Crete-à-Pierrot','Crête-à-Pierrot is sunk','German Navy (Panther)','Haitian rebels (Crête-à-Pierrot)')
new navalEvent('Battle of Chemulpo Bay','Varyag is scuttled','Japanese under Uryū','Russians under Rudnev (Varyag)')
new navalEvent('Hitachi Maru Incident','','Russians under Bezobrazov','Japanese')
new navalEvent('Battle of the Yellow Sea','','Japanese under Tōgō','Russians under Vitgeft')
new navalEvent('Battle of the Japanese Sea','','Japanese under Kamimura','Russians under Jessen')
new navalEvent('Battle of Korsakov','','Japanese under Sentō','Russians under Schultz')
new navalEvent('Battle of Tsushima','','Japanese under Tōgō','Russians under Rozhestvensky')
new navalEvent('Dutch intervention in Bali','Dutch take control of southern Bali','Dutch under van Tonnigen','Balinese under I Gusti Ngurah Made Agung')
new navalEvent('Revolt of the Lash','','Afro-Brazilian and mixed-race sailors under Cândido','Brazilian Navy')
new navalEvent('Battle of Preveza','','Italians under di Ruffia','Ottomans')
new navalEvent('Battle of Kunfuda Bay','','Italians under Paladini','Ottomans')
new navalEvent('Battle of Beirut','','Italians under Revel','Ottomans')
new navalEvent('Capture of Lemnos','Greeks occupy Lemnos','Greeks under Kountouriotis','Ottomans')
new navalEvent('Battle of Kaliakra','','Bulgarians under Dobrev','Ottomans under Orbay')
new navalEvent('Battle of Elli','','Greeks under Kountouriotis','Ottomans')
new navalEvent('Naval Battle of Lemnos','','Greeks under Kountouriotis','Ottomans')
new navalEvent('Romanian landings in Bulgaria','Results in the Treaty of Bucharest','Romanians under Sebastian','Bulgarians')
new navalEvent('First Battle of Topolobampo','Constitutionalists forced to retreat','Huertistas','Constitutionalists')
new navalEvent('Third Battle of Topolobampo','Constitutionalist gunboat is sunk ','Huertistas','Constitutionalists')
new navalEvent('Battle of Veracruz','','Mexicans','United States occupies Veracruz')
new navalEvent('Fourth Battle of Topolobampo','','Constitutionalists','Constitutionalists raised their sunken gunboat only to have it sunk again')
new navalEvent('U-boat campaign','','Allies','Germans')
new navalEvent('Pursuit of Goeben and Breslau','Bloodless engagement; British fail to intercept Germans and they escape to Constantinople','Germans under Souchon (Goeben and Breslau)','French and British under Milne, Troubridge and Lapeyrère')
new navalEvent('Battle of Antivari','French and British force sinks Austrian cruiser in the Adriatic','French and British under Lapeyrère','Austrians under Pachner')
new navalEvent('Naval operations of the Kamerun campaign','','British and French under Dobell','Germans')
new navalEvent('Sinking of SS Kaiser Wilhelm der Grosse','Highflyer intercepts and sinks Kaiser Wilhelm der Grosse','British (Highflyer)','Germans (Kaiser Wilhelm der Grosse)')
new navalEvent('Siege of Tsingtao','Japanese recapture Tsingtao','British and Japanese','Germans and Austrians')
new navalEvent('Battle of Heligoland Bight','British Grand Fleet ambushes and sinks German ships on patrol off Germany\'s coast; led Germany to pursue a fleet in being strategy for most of the rest of the war','British under Tyrwhitt and Keyes','Germans under Maass and Hipper')
new navalEvent('Occupation of German Samoa','','New Zealand','Germany')
new navalEvent('Allied occupation of German New Guinea','','Australians and Japanese under Holmes and Patey','Germans')
new navalEvent('Sinking of SMS Cap Trafalgar','','British (Carmania)','Germans (Cap Trafalgar disguised as Carmania)')
new navalEvent('Battle of Zanzibar','','Germans under Looff (Königsberg)','British (Pegasus)')
new navalEvent('Action of 22 September','','Germans under Weddigen (U-9)','British')
new navalEvent('Bombardment of Madras','Germans destroy Indian oil refinery in Madras and sinks one merchant ship','Germans under Müller (Emden)','Indians')
new navalEvent('Bombardment of Papeete','','Germans under Spee (Scharnhorst and Gneisenau)','French under Destremau (Zélée)')
new navalEvent('Battle off Texel','','British under Fox','Germans')
new navalEvent('Battle of Penang','','Germans under Müller (Emden)','Russians, French and British (Zhemchug)')
new navalEvent('Black Sea raid','','Ottomans under Souchon','Russians')
new navalEvent('Battle of Rufiji Delta','German cruiser is blockaded for months before being sunk','British under Drury-Lowe (Mersey and Severn)','Germans under Looff (Königsberg)')
new navalEvent('Battle of Coronel','','Germans under von Spee','British under Cradock')
new navalEvent('Battle of Cocos','','Australians under Glossop (Sydney)','Germans under Müller (Emden)')
new navalEvent('Battle of Cape Sarych','','Russians under Eberhardt','Ottomans under Souchon')
new navalEvent('Battle of the Falkland Islands','','British under Sturdee','Germans under von Spee')
new navalEvent('Raid on Scarborough, Hartlepool and Whitby','Little damage is done in battle; neither side losses ships','Germans under Hipper and Ingenohl','British under Warrender and Beatty')
new navalEvent('Raid on Cuxhaven','German U-boats pursue attacking British airships, but fail to stop them','British','Germans')
new navalEvent('Battle of Dogger Bank','In the North Sea','British under Beatty','Germans under Hipper (Blücher)')
new navalEvent('Naval operations in the Dardanelles Campaign','Mainly carried out by the Royal Navy with substantial support from the French and minor contributions from Russia and Australia','Turkish','British and French')
new navalEvent('Battle of Más a Tierra','Dresden is scuttled','British under Luce','Germans under Lüdecke (Dresden)')
new navalEvent('Battle off Noordhinder Bank','','British','Germans')
new navalEvent('Sinking of the RMS Luistania','Germans kill 1193 civilians when torpedoing an ocean liner; the international opinion turns against Germany','Germans (U-20)','British (Lusitania)')
new navalEvent('Action of 10 May','','Inconclusive: Russians under Eberhardt vs Ottomans under Ackermann','Near the Bosporus')
new navalEvent('Bombardment of Ancona','Italian destroyer damaged','Austro-Hungarians','Italian')
new navalEvent('Action off Vieste','','Austro-Hungarians','Italian')
new navalEvent('Raid on Porto Buso','Italians raid and capture Austro-Hungarian naval base','Italians (Zeffiro)','Austro-Hungarians')
new navalEvent('Russian raid on Gotland','Russians intercept and sink mine-laying Albatros off the Åland Islands; Roon and Prince Adalbert are damaged','British and Russians under Bakhirev','Germans')
new navalEvent('Action of 8 June','','Austro-Hungarians','Italians')
new navalEvent('Battle of the Gulf of Riga','Germans prevented from breaking into the Gulf of Riga','Russians and British under Kanin','Germans under Hipper')
new navalEvent('First Baralong incident','U-27 is sunk','British under Herbert (Baralong)','Germans (U-27)')
new navalEvent('Second Baralong incident','U-41 is sunk','British (Baralong)','Germans (U-41)')
new navalEvent('Hvalen incident','Hvalen is damaged, 1 sailor killed.','Germans (3 merchant raiders)','Swedish (Hvalen)')
new navalEvent('Battle of Kirpen Island','Two Ottoman gunboats sunk','Russians','Ottomans')
new navalEvent('Battle of Lake Tanganyika','Battle for control of Lake Tanganyika','British and Belgians under Spicer-Simson (Mimi and Toutou)','Germans')
new navalEvent('First Battle of Durazzo','','Italians, British, & French','Austro-Hungarians')
new navalEvent('Action of 8 January','Brief exchange of fire in the Black Sea','Russians under Eberhardt','Ottomans under Souchon')
new navalEvent('Action of 16 January','Off Madeira','Germans (Möwe)','British')
new navalEvent('Second Battle of Dogger Bank','Arabis is sunk','Germans','British (Arabis)')
new navalEvent('Action of 29 February','German commerce raider is sunk in the North Sea; British lose one armed merchant cruiser','British under Wardle','Germans (Greif)')
new navalEvent('Raid on Ruse','','Romanians','Austrians')
new navalEvent('Action of 6 September','In the Black Sea','Bulgarians (Podvodnik No. 18)','Russians (Bystry and Gromki)')
new navalEvent('Battle of Dover Strait','Germans launch raid into the Dover Strait to disrupt shipping','Germans under Michelsen','British')
new navalEvent('Action of 5 November','','British under Laurence','Germans')
new navalEvent('Action of 10 March','','Germans under Schlodien (Möwe)','New Zealand under Smith')
new navalEvent('Action of 16 March','Leopard sunk','British under Martin-Leake (Achilles)','Germans (Leopard)')
new navalEvent('Action of 17 March','German raid on British shipping in the Strait of Dover, Ramsgate and Margate','Germans','British')
new navalEvent('Scuttling of SMS Cormoran','Cormoran\'s crew scuttles the ship before it can be captured','Americans under Smith','Germans under Zuckschwerdt (Cormoran)')
new navalEvent('Battle of Dover Strait','Destroyer battle','British under Mountevans','Germans')
new navalEvent('Action of 15 August','','Germans','British under Crisp')
new navalEvent('Operation Albion','Germans occupy West Estonian archipelago','Germans under Schmidt','Russian under Bakhirev and Altvater')
new navalEvent('Action of 15 October','','Americans (Cassin)','Germans (U-61)')
new navalEvent('Battle of Moon Sound','In the Baltic Sea','Germans under Schmidt','Russians under Bakhirev')
new navalEvent('Action off Lerwick','Off the Shetland Islands','Germans (Brummer and Bremse)','British')
new navalEvent('Action of 17 November','','Americans under Berrien and Carpender','Germans (U-58)')
new navalEvent('Action of 11–12 December','','Germans under Scheer and Heinrich','British under Cavendish and Molteno')
new navalEvent('USS Monocacy incident','','Americans','Chinese')
new navalEvent('Battle of Imbros','','British and Greeks','Ottomans and Germans under Paschwitz')
new navalEvent('Action of 14/15 February','','Germans under Schröder and Heinecke [de]','British under Keyes and Berry')
new navalEvent('Invasion of Åland','Foreign forces pushed out of Åland','Soviet Russia, Finnish Reds','German, Swedish, White Russians, & Finnish Whites')
new navalEvent('Zeebrugge Raid','Failed attempt to scuttle ships in Zeebrugge channel to prevent Germans from reaching open water','Germans under Schröder','British under Jellicoe, Keyes and Bacon')
new navalEvent('First Ostend Raid','','Germans','British under Lynes and Godsal')
new navalEvent('Action of 8 May','U-32 is sunk by depth charges','British (Wallflower)','Germans (U-32)')
new navalEvent('Second Ostend Raid','Failed attempt to scuttle ships in Ostend channel to prevent Germans from reaching open water','Germans','British under Keyes')
new navalEvent('Action of 21 May','UC-56 was initially reported to be sunk but was later discovered to have just been damaged','Americans (Christabel)','Germans (UC-56)')
new navalEvent('Sinking of SS Carolina','American passenger liner is sunk','Germans (U-151)','Americans (Carolina)')
new navalEvent('Sinking of the SMS Szent István','Italian MAS-15 torpedoes sink Szent István','Italians','Austor-Hungarians (Szent István)')
new navalEvent('Action of 18 June','Germans torpedo Dwinsk; U-151 is later engaged by Americans (Von Stuben), but escapes','Germans (U-151)','British (Dwinsk)')
new navalEvent('Tondern raid','British air raid on German airfield in Todern','British (Furious)','Germans')
new navalEvent('Attack on Orleans','Off Massachusetts','Germans (U-156)','Americans')
new navalEvent('Battle of Lake Baikal','On Lake Baikal','Czechoslovaks under Gadja','Russians')
new navalEvent('Action of 25 August','Brazilian fleet sailing from Freetown to Dakar is attacked by German U-boats, but suffer no losses. They successfully sink one U-boat in their counterattack.','Brazilians','Germans')
new navalEvent('Second Battle of Durazzo','Durazzo is decimated','Italians, British, Australians, & Americans','Austro-Hungarians')
new navalEvent('Action of 14 October','Portuguese ship is sunk but civilian steamer is successfully defended','Portuguese (Augusto de Castilho)','Germans under de la Perière (U-139)')
new navalEvent('Raid on Pula','Italians sink Viribus Unitis without knowing it had been transferred to the State of Slovenes, Croats, and Serbs the day prior','Italians under Revel','Austro-Hungarians (Viribus Unitis)')
new navalEvent('British Baltic Campaign','Estonia and Latvia gain independence','British, White Russia, Estonians and Latvians','Bolsheviks')
new navalEvent('Battle of Alexandrovsky Fort','','British and White Russia under Norris','Bolsheviks')
new navalEvent('Raid on Kronstadt','','British under Dobson and Donald','Bolsheviks')
new navalEvent('Action of 3 May','Le Scarpe is captured','Russians (Krasnaya Zarya)','French (Le Scarpe)')
new navalEvent('Anzali Operation','Ten White Russian auxiliary cruisers captured; Persian Socialist Soviet Republic established','Bolshevik Russians and Persian Jangalis under Raskolnikov','British and White Russians under Bateman-Champain')
new navalEvent('Alice Dollar incident','','Americans','Chinese rebels')
new navalEvent('Battle of Obytichnyi Spit','','Inconclusive: White vs Red Russians','Both sides claim victory')
new navalEvent('Action of 9 January','','French','Bolshevik Russians')
new navalEvent('Action of 8 February','C-27 is damaged and retreats','Turks (Alemdar)','French (C-27)')
new navalEvent('Capture of the Upnor','Upnor, which is carrying weapons, is captured','Irish Republican Army (Warrior)','British (Upnor)')
new navalEvent('Battle of Tarapacá','Colombians bombard Peruvian river defenses ','Colombians','Peruvians')
new navalEvent('Battle of Tillyria','Cypriot patrol ships engage Turkish Cypriot militia before being sunk by Turkish fighter jets','Turkish Cypriots','Greek Cypriots (Phaethon)')
new navalEvent('Action of 13 December','','Australians (Teal)','Indonesians')
new navalEvent('Vũng Rô Bay incident','North Vietnamese fail to secretly invade South Vietnam\'s water to support Viet Cong escalating the war','South Vietnamese','North Vietnamese')
new navalEvent('Battle of Dongshan','','Chinese','Taiwanese (Jiang Men and Zhang Jiang)')
new navalEvent('Battle of East Chongwu','','Chinese','Taiwanese (Lin Huai and Shan Hai)')
new navalEvent('Battle of Rumani Coast','','Egyptians','Two Egyptian torpedo boats sunk')
new navalEvent('Operation Tiger Claw','','Nigerians','Biafrans')
new navalEvent('Sinking of the Eliat','Eilat sunk in the first combat use of P-15 Termit surface-to-surface missiles','Egyptians','Israelis (Eilat)')
new navalEvent('Pueblo incident','North Koreans capture Pueblo','North Koreans under Kim','Americans under Bucher (Pueblo)')
new navalEvent('Action of 1 March','Four North Vietnamese naval trawlers sunk','Americans and South Vietnamese','North Vietnamese')
...
new navalEvent('Sinking of Khukri','Khukri is sunk','Pakistanis (Hangor)','Indians (Khukri)')
new navalEvent('First Battle of Quảng Trị','Americans engage in tank and artillery duals at and below DMZ and in defense of Đông Hà Bridge','North Vietnamese','South Vietnamese')
new navalEvent('Battle of Đồng Hới','','North Vietnamese','Americans')
new navalEvent('Operation Pocket Money','','Americans under Cooper','North Vietnamese')
new navalEvent('Operation Custom Tailor','','Americans','North Vietnamese')
new navalEvent('Battle of Latakia','','Israelis under Barkai','Syrians')
new navalEvent('Battle of Marsa Talamat','Egyptian patrol boat sunk','Israelis','Egyptians under Zikry')
new navalEvent('Battle of Baltim','','Israelis','Egyptians')
new navalEvent('Battle of Latakia','','Syrians','Israelis under Barkai')
new navalEvent('Battle of the Paracel Islands','Chinese take full control of the Paracels Islands','Chinese','Vietnamese')
new navalEvent('Battle of Pentemili beachhead','Two Cypriot torpedo boats are sunk trying to intercept Turkish amphibious assault','Turkish','Cypriots')
new navalEvent('East Sea Campaign','Series of clashes that led to the North Vietnamese capture of the Spratly Islands','South Vietnamese under Chung','North Vietnamese and Viet Cong')
...
new navalEvent('Operation Morvarid','Destruction of 80% of the Iraqi Navy','Iranians under Afzali','Iraqis')
new navalEvent('Sinking of the coaster ship Nellie M','An IRA active service unit hijack a lifeboat at Moville and sink a small cargo ship with an explosive charge','Irish Republicans','British')
new navalEvent('Sinking of the coaster ship St. Bedan','','Irish Republicans','British')
new navalEvent('Invasion of South Georgia','','Argentines','British under Mills')
new navalEvent('Operation Paraquet','','Argentines (Santa Fe)','Santa Fe is severely damaged, sunk and later scuttled')
new navalEvent('Sinking of the ARA General Belgrano','','Argentines (General Belgrano)','General Belgrano is torpedoed and sunk')
new navalEvent('Attack on the ARA Alferez Sobral','Two British Westland Lynx HAS.Mk.2/3 helicopters attack Alferez Sobral','British','Argentine (Alferez Sobral)')
new navalEvent('Sinking of HMS Sheffield','Fighter jets sink Sheffield with an Exocet missile','Argentines','British (Sheffield)')
new navalEvent('Battle of San Carlos','Coventry, Ardent and Antelope are sunk during a British landing on the shores of San Carlos Water; British successfully establish a beachhead','British under Woodward, Clapp and Thompson (Coventry, Ardent and Antelope)','Argentines under Menendez and Crespo')
new navalEvent('Battle of Seal Cove','','Argentines','British')
new navalEvent('Sinking of SS Atlantic Conveyor','','Argentines','British (Atlantic Conveyor)')
new navalEvent('Bluff Cove air attacks','Argentine aerial bombs destroy Sir Galahad and Sir Tristam; Sir Galad is scuttled on 21 June and Sir Tristam, though seriously damaged, later returns to service','Argentines under Crespo, Menendez and Lombardo','British under Moore, Clapp, Thompson and Wilson (Sir Galahad and Sir Tristam)')
new navalEvent('Battle of Two Sisters','','British (Glamorgan)','Argentines')
new navalEvent('Sinking of Transit','Transit is sunk off Tripoli, Lebanon; of the 56 refugees en route to Larnaca, Cyprus, 25 are killed','Israelis','Lebanese')
new navalEvent('Sinking of Milanian and Kahnamoie','Milanian and Kahnmoie are sunk by Exocet missiles','Iraqis','Iranians (Milanian and Kahnamoie)')
new navalEvent('Sinking of the Raffaello','Raffaello is partially sunk by an Exocet missile while in port in Bushehr','Iraqis','Iranians (Raffaello)')
new navalEvent('Operation Nobilis','South African Navy destroys three Angolan missile boats in Luanda','South Africans','Angolans')
new navalEvent('Action in the Gulf of Sidra','','Americans','Libyans')
new navalEvent('USS Stark incident','Stark is severely damaged by missiles from Iraqi fighter jets','Iraqis','Americans (Stark)')
new navalEvent('Bridgeton incident','American-escorted Kuwaitian convoy is attacked and Bridgeton is mined','Iranians','Americans and Kuwaitians (Bridgeton)')
...
new navalEvent('RFA Fort Victoria bombing','Fort Victoria bombed and heavily damaged while at dock at Harland & Wolff shipyard','Irish Republicans','British (Fort Victoria)')
new navalEvent('Battle of Ad-Dawrah','Coalition captures Iraqi oil platforms','Coalition (Nicholas and Istiqal)','Iraqis')
new navalEvent('Battle of Qurah and Umm al Maradim','Four Iraqi warships sunk','Coalition (Leftwich and Curts)','Iraqis')
new navalEvent('Battle of Bubiyan','Bulk of the Iraqi Navy is destroyed','Coalition','Iraqis')
new navalEvent('Battle of Assab','Seven Ethiopian warships are sunk in port and the remaining warships flee before the city falls; this is the last combat action of the Ethiopian Navy before its dissolution due to Ethiopia becoming landlocked','Eritreans','Ethiopians')
new navalEvent('Battle of the Dalmatian Channels','Yugoslavs lose three ships ','Croatians under Letica','Yugoslavs')
new navalEvent('Sinking of the Sagarawardena','LTTE suicide boats attack and sink Sagarawardena','Liberation Tigers of Tamil Eelam','Sri Lankans (Sagarawardena)')
new navalEvent('Bombing of SLNS Sooraya and SLNS Ranasuru','','Liberation Tigers of Tamil Eelam','Sri Lankans (Sooraya and Ranasuru')
new navalEvent('Hanish Islands conflict','Eritreans launch amphibious assault on Hanish Islands and successfully occupy them until 1998','Eritreans','Yemenis')
new navalEvent('Battle of Mullaitivu','Ranaviru is attacked and sunk, killing all but two of her crew','Liberation Tigers of Tamil Eelam under Soosai','Sri Lankans (Ranaviru)')
new navalEvent('Sokcho submarine incident','','South Koreans','North Koreans')
new navalEvent('Yosu submersible incident','','South Koreans','North Koreans')
new navalEvent('Battle of Yeonpyeong','','South Koreans','North Koreans')
new navalEvent('USS Cole bombing','','Al-Qaeda','Americans (Cole)')
new navalEvent('Gaza suicide boat attack','','Hamas','Israel')
new navalEvent('Battle of Amami-Ōshima','','Japanese','North Koreans')
new navalEvent('Battle of Al Faw','','Coalition','Iraqis')
new navalEvent('Action of 18 March','','Americans','Somali pirates')
new navalEvent('Battle of Point Pedro','','Sri Lanka Navy','LTTE Sea Tigers')
new navalEvent('Attack on INS Hanit','','Israelis (Hanit)','Hezbollah')
new navalEvent('Battle of Point Pedro','','Sri Lanka Navy','LTTE Sea Tigers')
new navalEvent('Action of 28 October','','Americans','Somali pirates')
new navalEvent('Action of 3 March','Pirate skiff is captured ','Germans and Americans (Rheinland-Pfalz)','Somali pirates')
new navalEvent(
	"Maersk Alabama hijacking",
	"",
	"Americans (MV Tygra)","Somali pirates"
)
new navalEvent(
	"Maersk Alabama hijacking",
	"",
...
new navalEvent(
	...
	"",
	"Germans","Somali pirates"
)
new navalEvent(
	"ROKS Cheonan sinking",
	"Cheonan is torpedoed and sunk by a North Korean Yono-class submarine ",
	"North Koreans","South Koreans (Cheonan)"
)
new navalEvent(
	"2010 Gaza flotilla raid",
	"Six civilian ships of the Gaza Freedom Flotilla were raided by Israel on 31 May 2010 in international waters in the Mediterranean Sea. Ten of the flotilla passengers were killed, with 29 wounded ,Ten Israeli soldiers were wounded,the ships were carrying humanitarian aid intending to break the Israeli naval blockade of the Gaza Strip. ",
	"Israel","2010 Gaza Freedom Flotilla"
)
new navalEvent(
	"Operation Dawn of Gulf of Aden",
	"21 hostages safely rescued from the Somali pirates ",
	"Republic of Korea Navy Supported by Royal Navy of Oman and United States Navy","Somali pirates"
)
new navalEvent(
	"Action of 29 April",
	"Courbet engages four Libyan RHIB mineplanters off Misrata, sinking one",
	"French (Courbet)","Libyan RHIB"
)
new navalEvent(
	"Action of 12 may",
	"Naval attack on the city of Misrata is repulsed by Canada, UK and France",
	"Canadian, British and French","Libyans"
)
new navalEvent(
...
new navalEvent(
	"Attack on COSCO Asia",
	"Militants attacked Panamanian-flagged container ship COSCO Asia using RPG while it was in the Suez canal, the ship suffered minor damages and the three militants involved in the attack were arrested according to Egyptian Authorities",
	"Egypt","Al Furqan Brigades"
)
new navalEvent(
	"Capture of the Cherkasy",
	"Cherkasy is boarded and captured by Russian forces after attempting to flee Crimea ",
	"Russians under Chirkov, Vitko and Berezovsky","Ukrainians under Tenyukh, Hayduk, Fedash and Kovalenko (Cherkasy)"
)
new navalEvent(
	"Damietta ship hijacking",
	"On November 12, assailants hijacked an Egyptian Navy guided missile craft in Damietta. Egyptian military aircraft engaged the attackers, destroying the boat and killing the hijackers",
	"Egypt","Hijackers"
)
new navalEvent(
	"MT Orkim Harmony hijacking",
	"Hijack foiled",
	"Malaysians (Orkim Harmony)","Indonesian pirates"
)
new navalEvent(
...
new navalEvent(
	"Attack on HSV-2 Swift",
	"Swift is attacked by a C-802 anti-ship missile off Yemen and is severely damaged ",
	"Houthis","United Arab Emirates (Swift)"
)
new navalEvent(
	"Attack on HMS Al Madinah",
	"Saudi Al Madinah is struck by a remote-controlled suicide boat off Yemen and is severely damaged ",
	"Houthis","Saudis"
)
new navalEvent(
	"2018 Kerch Strait incident",
	"Skirmish at Kerch Strait",
	"Ukrainians","Russians"
)
new navalEvent(
	"2019 SEAL Team Six operation in North Korea",
	"Mission aborted after being detected by a North Korean boat and the SEALs were unable to plant the listening device, at least 3 North Korean civilian fishermen killed ",
	"North Korea","SEAL Team Six"
)
new navalEvent(
	"Attack on Stolt Apol",
	"British-flagged tanker Stolt Apol is attacked by two pirate skiffs 75 nautical miles off the coast of Yemen in the Gulf of Aden and disables one skiff before escaping ",
	"British (Stolt Apol)","Pirates"
)
new navalEvent(
	"Attack on the MOZART",
	"The container vessel, MOZART, was attacked by pirates in the Gulf of Guinea, around São Tomé and Príncipe, resulting in one crew member killed and 15 crew members kidnapped ",
	"Pirates","MOZART container vessel"
)
new navalEvent(
	"Siege of Mariupol",
	"Russians sink three Ukrainian warships ",
	"Ukrainians","Russians"
)
new navalEvent(
	"Snake Island campaign",
	"Russians fail to conquer the island ",
	"Ukrainians","Russians (Moskva and Vasily Bykov)"
)
new navalEvent(
	"Berdiansk port attack",
	"Russian forces capture a dozen Ukrainian warships but Saratov ",
	"Ukrainians","Russians (Saratov, Tsezar Kunikov and Novocherkassk)"
)
new navalEvent(
	"Sinking of the Sloviansk",
	"Sloviansk is sunk by a Russian Kh-31 anti-ship missile and is believed to have sunk with all hands ",
	"Russians","Ukrainians (Sloviansk)"
)
new navalEvent(
	"Sinking of the Moskva",
	"Moskva is struck by two Ukrainian R-360 Neptune anti-ship missiles, causing a chain reaction of explosions and later the sinking of the ship ",
	"Ukrainians","Russians (Moskva)"
)
new navalEvent(
	"Sinking of the Spastel Vasily Bekh",
	"Ukrainian Harpoon anti-ship missiles sink the Russian Navy rescue tug, Spasatel Vasily Bekh ",
	"Ukrainians","Russians (Spasatel Vasily Bekh)"
)
new navalEvent(
	"Attack on the RFS Velikiy Ustyug",
	"Ukrainian naval drones attack and damage the Russian Buyan M-class corvette, Velikiy Ustyug",
	"Russians (Velikiy Ustyug)","Ukrainians"
)
new navalEvent(
	"Drone attack on the Sevastopol Naval Base",
	"Ukrainian unmanned surface drones attack Sevastopol Naval Base in Crimea, damaging three Russian warships ",
	"Russians","Ukrainians"
)
new navalEvent(
	"Sinking of the Yuri Olefirenko",
	"Yuri Olefirenko is sunk by Russian anti-ship missiles while docked in Odesa; Ukraine has not confirmed nor denied the loss",
	"Russians","Ukrainians (Yuri Olefirenko)"
)
new navalEvent(
	"Attack on the Priazovye",
	"Russians repel Ukrainian sea drone attack on the Vishnya-class intelligence ship Priazovye ",
	"Russians (SSV-201 Priazovye)","Ukrainians"
)
new navalEvent(
	"First Missile Attack on Sevastopol",
	"Ukrainian cruise missiles strike Sevastopol shipyards, damaging RFS Minsk and RFS Rostov-na-Donu ",
	"Ukrainians","Russians (Minsk and Rostov-na-Donu)"
)
new navalEvent(
	"Attack on the Sergey Kotov",
	"Bykov-class patrol ship Sergey Kotov is attacked and severely damaged by Ukrainian sea drones",
	"Ukrainians","Russians (Sergey Kotov)"
)
new navalEvent(
	"Attack on the Samum",
	"Bora-class corvette Samum, is attacked and damaged by Ukrainian sea drones",
	"Ukrainians","Russians (Samum)"
)
new navalEvent(
	"Zikim attack",
	"Most of Hama\'s attack boats attempting to infiltrate Israel are intercepted and sunk, estimated 11 militants landed from a vessel that went through. Fighting took place outside Zikim, at three military bases, and on the adjacent coastline. At least 2 boats sunk by Israeli navy.",
	"Hamas","Israeli Navy"
)
new navalEvent(
	"Al-Asef attacks",
	"Hamas used their locally made \"Al-Asef\" submarine drones in their attack on 7 October ,On 31 October their Nukhba forces unit launched the UUV targeting the Israeli navy ,the IDF stated that several were intercepted By late 2023,the attacks all but stopped ,Hamas' naval unit was heavily degraded ",
	"Hamas","Israeli Navy"
)
new navalEvent(
	"Attack on the Pavel Derzhavin",
	"Bykov-class patrol ship Pavel Derzhavin is attacked and damaged by Ukrainian sea drones",
	"Ukrainians","Russians (Pavel Derzhavin)"
)
new navalEvent(
	"Sinking of the Askold",
	"Askold is damaged by Ukrainian cruise missiles while docked in Kerch ",
	"Ukrainians","Russians (Askold)"
)
new navalEvent(
	"Sinking of the Novocherkassk",
	"Novocherkassk is damaged by Ukrainian cruise missiles while docked in Feodosia ",
	"Ukrainians","Russians (Novocherkassk)"
)
new navalEvent(
	"Attacks on the MV Maersk Hangzhou",
	"Maersk Hangzhou is attacked by Houthis; shipping is stopped in the Red Sea. Three Houthi fast attack craft were sunk by US Navy. ",
	"Houthis","Americans (Maersk Hangzhou)"
)
new navalEvent(
	"Capture of the Yunus",
	"A fishing boat called the Yunus carrying weapons including missile parts from Iran to the Houthis was intercepted and captured by Navy 🦭🦭🦭🦭s, during the raid two navy seals from USS Lewis B. Puller (ESB-3) fell off the ship into the sea and drowned. the head of the smuggling operation \"a Pakistani named Muhammad Pahlawan\" received a 40 years prison sentence",
	"US Navy","Houthis"
)
new navalEvent(
	"Sinking of the Ivanovets",
	"Russian Tarantul-class corvette Ivanovets sunk by Ukrainian sea drones off Crimea",
	"Ukrainians","Russians (Ivanovets)"
)
new navalEvent(
	"Sinking of the Tsezar Kunikov",
	"Russian Ropucha-class landing ship Tsezar Kunikov sunk by Ukrainian sea drones off Crimea",
	"Ukrainians","Russians (Tsezar Kunikov)"
)
new navalEvent(
	"Attack on the Bentley-I",
	"In the Red Sea, the Panamaninan-flagged tanker Bentley-I is unsuccessfully attacked by a Houthi sea drone before engaging in a gun battle with two Houthi manned fast attack craft, which are driven off",
	"Crew of Bentley-I","Houthis"
)
new navalEvent(
	"Sinking of the Rostov-na-Donu",
	"Ukrainian drone and missile strikes on Sevastopol sink the Russian Kilo-class submarine Rostov-na-Donu, which was being repaired ",
	"Ukrainians","Russians (Rustov-na-Donu)"
)
new navalEvent(
	"Attacks on the Sounion",
	"In Red Sea, the Greek-flagged tanker Sounion was attacked and exchanged gunfire with two Houthi manned fast attack craft; Sounion was then hit by three projectiles and set afire before being abandoned by her crew",
	"Houthis","Greeks (Sounion)"
)
new navalEvent(
	"Attack on Latakia",
	"Israeli Navy attacks and sinks 15 Syrian warships at anchor to prevent them from falling into terrorist hands, including at least six Osa-class missile boat. ",
	"Israel","Syria"
)
new navalEvent(
	"Operation Rough Rider",
	"US withdrawal,Houthis suffer casualties and material damage, Ceasefire leads to Houthis no longer targeting U.S. ships while continuing to strike Israeli targets and commercial shipping. ",
	"Houthis","United States Navy"
)
new navalEvent(
	"May 2025 drone attack on Gaza Freedom Flotilla",
	"Disruption of the flotilla mission to break the Blockade of the Gaza Strip,the Armed Forces of Malta sent a patrol boat to extinguish the fire ",
	"Israel \"allegedly\"","Freedom Flotilla Coalition"
)
new navalEvent(
	"Sinking of the Simferopol",
	"Russian navy drone sunk Ukrainian reconnaissance ship Simferopol in the delta of the Danube River",
	"Russians","Ukrainians (Simferopol)"
)
new navalEvent(
	"2025 United States strikes on Venezuelan boats",
	"Many Boats attacked, at least 100 crew members killed ",
	"US navy","Tren de Aragua "
)
new navalEvent(
	"September 2025 drone attack on Gaza Sumud Flotilla",
	"11 ships hit with incendiary devices dropped by drones launched from a submarine citing two American intelligence officials, Italy and Spain dispatch naval vessels Virginia Fasan , Alpino and Furor to protect the flotilla but only in international waters. ",
	"Israel \"allegedly\"","Freedom Flotilla Coalition"
)
new navalEvent(
